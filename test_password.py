...
query = ['test_email', 'test_password', 'test_login', 'test_site', 'test_description']
arguments = argparse.Namespace(e='arguments_email', p='arguments_password', l='arguments_login', s='arguments_site', d='arguments_desc')
